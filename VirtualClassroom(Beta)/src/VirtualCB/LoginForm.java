...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {
        ...
        if(jTextField1.getText().equals("") || jTextField2.getText().equals("") ) {
            JOptionPane.showMessageDialog(jTextField2, "PLEASE ENTER USERNAME OR PASSWORD !!");
        }
        if(jRadioButton1.isSelected()==false && jRadioButton2.isSelected()==false){
            ...
            if(log){
                if(Desig.equals("Student")){
                    String Name=new dbFunction(Desig).getUsrname(userName,Desig);
                    new StudentMVForm(Name).setVisible(true);
                    this.dispose();
                }
                else{
                    String Name=new dbFunction(Desig).getUsrname(userName,Desig);
                    new TeacherNGForm(Name).setVisible(true);
                    this.dispose();
                }
            }
            else{
                JOptionPane.showMessageDialog(jButton1,"INVALID DETAILS");
            }
        }
    }
